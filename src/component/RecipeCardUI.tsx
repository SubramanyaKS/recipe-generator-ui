import { copyRecipe, handleDownloadRecipe, speak } from '../services/services';
import IconButton from './IconButton'
import { ClipboardIcon, DownloadIcon, Volume2Icon } from 'lucide-react'
    ...
    <div className='h-1/2 shadow-lg rounded-lg mt-4  w-1/2 flex justify-center items-center'>
      <div className='w-full max-w-4xl p-4'>
        ...
        {recipes ? <div className="flex flex-row justify-between m-3">
          ...
          <IconButton color="bg-[var(--primary-color)] hover:bg-[var(--accent-color)]" Icon={<Volume2Icon />} title="Speak" onClick={() => speak(recipes)} />
